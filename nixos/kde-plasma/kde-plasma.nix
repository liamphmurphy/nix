{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-6bf4cdaa-09c8-4ceb-be1d-89384560eff3" = [ ];
      ...
      "firefox.desktop"."new-window" = "Ctrl+Alt+F";
      ...
      "kwin"."Window Pack Up" = [ ];
      "kwin"."Window Quick Tile Bottom" = ["Ctrl+Alt+Down" "Meta+Down"];
      "kwin"."Window Quick Tile Bottom Left" = [ ];
      "kwin"."Window Quick Tile Bottom Right" = [ ];
      "kwin"."Window Quick Tile Left" = ["Ctrl+Alt+Left" "Meta+Left"];
      "kwin"."Window Quick Tile Right" = ["Ctrl+Alt+Right" "Meta+Right"];
      "kwin"."Window Quick Tile Top" = ["Ctrl+Alt+Up" "Meta+Up"];
    ...
    files = {
      ...
      "kactivitymanagerdrc"."activities"."6bf4cdaa-09c8-4ceb-be1d-89384560eff3" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "6bf4cdaa-09c8-4ceb-be1d-89384560eff3";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{ade60181-9b9a-4f36-bf43-4971e0b2d984}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{206bccaa-6b51-423c-be92-89a0ab349646}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{fd8b6d1a-def5-403e-b948-53e155b2a9dc}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{19d3f228-db0d-469d-888a-922699b680ed}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{aaa32cfb-73e6-4176-9175-1ab9cb63ec13}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{66bb26a7-567b-470c-89ff-1da1bb7495a4}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{0eeed1b5-f2b7-468b-a278-de3682373adf}";
      ...
      "kwinrc"."Desktops"."Id_1" = "a9288677-c365-4b6b-80b3-39a616497be3";
      "kwinrc"."Desktops"."Id_2" = "9148a283-4a26-4162-b720-41615b1a3662";
      "kwinrc"."Desktops"."Name_2" = "New Desktop";
      "kwinrc"."Desktops"."Number" = 2;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."TabBox"."LayoutName" = "thumbnails";
      "plasma-localerc"."Formats"."LANG" = "en_US.utf8";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/nix/store/x5fdb0d14vkacgrihi3vahd1qfm5hhwk-breeze-qt5-5.24.5-bin/share/wallpapers/Next/contents/images/2560x1440.jpg,/run/media/liam/minimus/walls/wallhaven-ey3vml.png";
      "systemsettingsrc"."Open-with settings"."CompletionMode" = 1;
      "systemsettingsrc"."Open-with settings"."History" = "firefo";
    };
  };
}
